...
const DataTable = () => {
  return (
    <table class="table-auto w-full border-collapse xs:hidden lg:table">
      <thead>
        <tr className="xs:text-[14px] md:text-[.8vw] lg:text-[1vw] xl:text-[.8vw] xs:hidden md:table-row">
      ...
      <tbody>
        {tableData.map((item, i) => (
          <tr
            key={i}
            className="border border-[#FF005C] bg-[#110012] xs:text-[14px] md:text-[.8vw] lg:text-[1vw] xl:text-[.8vw]"
          >
