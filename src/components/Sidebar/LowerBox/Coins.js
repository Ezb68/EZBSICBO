...
const Coins = ({ mobile }) => {
  ...
  return (
    <div className="xs:rounded-none md:rounded-[10px] xs:mx-0 md:mx-auto border border-[#7C1F58] xs:border-b-0 md:border-b mt-4 flex xs:flex-nowrap md:flex-wrap xs:p-5 md:p-2 xs:space-x-2 md:space-x-0 items-center">
